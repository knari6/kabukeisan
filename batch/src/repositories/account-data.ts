import { AccountDatas } from "@prisma/client";
import { FinancialStatement } from "../libs/interfaces";

export class AccountDataRepository {
  constructor(data: FinancialStatement) {}

  public static dto(data: FinancialStatement): AccountDatas {
    return {
      ...
      // impairment_loss: data.incomeStatement.impairmentLoss.toString(),
  ...
  public async write(accountData: AccountDatas) {}
}
