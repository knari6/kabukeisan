...
export const financialTestData: FinancialData = {
  ...
  incomeStatement: {
    ...
    incomeBeforeIncomeTax: random.randomInt(1000000, 9999999),
    tax: random.randomInt(1000000, 9999999),
    profitLoss: random.randomInt(1000000, 9999999),
  },
  cashFlowStatement: {
    netCashProvidedByOperatingActivity: random.randomInt(1000000, 9999999),
    netCashProvidedByInvestingActivity: random.randomInt(1000000, 9999999),
    netCashProvidedByFinancingActivity: random.randomInt(1000000, 9999999),
  ...
  capitalExpenditure: {
    ...
    researchAndDevelopmentExpense: random.randomInt(1000000, 9999999),
  },
  interestBearingDebt: {
